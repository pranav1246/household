...
from applications.logout import LogoutAPI
...
from applications.resources.DSerivceTable import ServiceDetailsAPI
...
api.add_resource(ServiceDetailsAPI, '/service-details')
